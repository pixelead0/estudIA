...
- **Considerar Variables**: Se trata de identificar meticulosamente todos los factores o elementos que influyen en una situación determinada(2). Si planeas un viaje, las variables son el dinero, el transporte, el clima y los permisos.
- **Otros Puntos de Vista**: Consiste en preguntarse: "¿Qué pensaría mi profesor? ¿Qué pensaría un niño pequeño? ¿Qué pensaría mi mejor amigo?". Esta técnica nos ayuda a ver detalles y soluciones que desde nuestra propia posición solemos ignorar(3).
- **Consecuencias**: No te quedes solo en el presente. Analizar las consecuencias te permite prever qué pasará en el futuro y tomar decisiones mucho más responsables y completas(6).
...
| :--- | :--- | :--- | :--- |
| **Paso 1: Explorar.** | Distancia, plan de estudios, talleres, costo, ambiente. | Mis padres (quieren seguridad). Mis amigos (quieren estar juntos). | Elegir bien me facilitará la entrada a la universidad. |
...
- **Dato curioso**: La técnica de la Lluvia de Ideas fue creada en 1939 por Alex Osborn. Él descubrió que las ideas fluyen mejor cuando no hay miedo a ser juzgado.
