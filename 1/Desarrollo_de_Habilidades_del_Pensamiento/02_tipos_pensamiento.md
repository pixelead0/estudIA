...
### 1. Tu Cinturón de Herramientas (Modos de Pensar)
...
### 2. Caminos a la Verdad (Deducir e Inducir)
...
Identifica qué herramienta mental es la mejor para cada misión:

| Misión / Desafío | Herramienta a elegir | ¿Por qué esta herramienta?(5) |
| :--- | :--- | :--- |
| **Resolver una ecuación de matemáticas.** | Pensamiento Lógico. | Requiere seguir pasos y reglas exactas. |
| **Inventar un personaje para un cuento.** | Pensamiento Creativo. | Necesitas originalidad y cosas nuevas. |
| **Saber si una noticia de Internet es real.** | Pensamiento Crítico. | Debes buscar pruebas y no creerlo todo. |
