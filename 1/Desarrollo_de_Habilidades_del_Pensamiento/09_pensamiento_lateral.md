...
**Objetivo:** Romper supuestos ocultos y resolver acertijos con pensamiento lateral, no solo con lógica directa.

**Cómo practicar (siempre en este orden):**

1. Lee el acertijo.
2. Pregúntate: **¿qué estoy dando por hecho sin comprobarlo?**
3. Recién entonces abre la **clave** y compara.

> [!TIP]
> Si la respuesta “obvia” no encaja, no caves el mismo hoyo más profundo: **cambia de pasadizo**.

### Ejemplo resuelto — El hombre del piso 10

| Lo que das por hecho | Pasadizo mental | Solución |
| :--- | :--- | :--- |
| Que sube escaleras por ejercicio o salud. | ¿Y si no alcanza el botón del 10? | Es de baja estatura; con lluvia usa el paraguas o alguien le ayuda(4). |

**Idea clave:** El acertijo no pide más lógica vertical: pide **cuestionar lo obvio**.

---

### 🔍 Caso 1 — Lluvia sin mojarse

**Tu turno:** Un hombre camina bajo la lluvia y no se moja ni un pelo. ¿Qué supuesto estás asumiendo sobre él?

**Clave:** Supones que tiene cabello. **El hombre es calvo**(4).

**Por qué importa:** Muchos bloqueos vienen de detalles que “damos por hecho” sin preguntar.

---

### 🔍 Caso 2 — La pelota que regresa

**Tu turno:** ¿Cómo tirar una pelota para que vuelva a ti sin que choque con nada?

**Clave:** Supones que la tiras hacia adelante. **Tírala hacia arriba**(3).

**Por qué importa:** Cambiar la dirección del problema es un pasadizo clásico del pensamiento lateral.

---

### 🔍 Caso 3 — Dos padres y dos hijos

**Tu turno:** Dos padres y dos hijos van de pesca y pescan 3 peces. Cada uno se lleva uno. ¿Cuántas personas son?

**Clave:** Supones que son 4 personas. Son **abuelo, papá e hijo** (3 personas).

**Por qué importa:** Las palabras engañan; hay que desarmar el problema en piezas reales.

---

### 🔍 Caso 4 — Las diez ovejas

**Tu turno:** Un granjero tiene 10 ovejas y mueren todas menos 9. ¿Cuántas quedan?

**Clave:** Supones que debes restar. **Quedan 9** (las que no murieron).

**Por qué importa:** A veces la “operación matemática” es la trampa, no la solución.

---

### 🔍 Caso 5 — El mes de 28 días

**Tu turno:** ¿Qué mes del año tiene 28 días?

**Clave:** Supones que solo febrero. **Todos los meses tienen al menos 28 días**(2).

**Por qué importa:** Leer la pregunta literalmente evita la respuesta que “suena” correcta.

---

### 🔍 Caso 6 — Siete hijas, un hermano

**Tu turno:** Una mujer tiene 7 hijas y cada una tiene un hermano. ¿Cuántos hijos tiene en total?

**Clave:** Supones un hermano distinto para cada hija. Tiene **8**: las 7 hijas y **un** hermano de todas.

**Por qué importa:** “Cada una” no siempre significa “cada una diferente”.

---

### 🔍 Caso 7 — Se moja al secar

**Tu turno:** ¿Qué se moja mientras te está secando?

**Clave:** Supones que es algo que produce agua. **Una toalla**.

**Por qué importa:** El lateral invierte roles: lo que seca también absorbe.

---

### 🔍 Caso 8 — Atrás y adelante a la vez

**Tu turno:** ¿Cómo puedes estar atrás de tu amigo y él atrás de ti al mismo tiempo?

**Clave:** Supones que caminan en fila. **Espalda con espalda**.

**Por qué importa:** Cambiar la posición en el espacio cambia por completo la pregunta.

---

### Cierra la práctica

Inventa **un mini-acertijo** para un compañero (dos líneas) y escribe debajo:

- **Supuesto que quieres romper:** …
- **Respuesta lateral:** …

Si puedes diseñar la trampa, ya dominas el pasadizo.
...
- **El Acertijo de las Velas**: Para resolver retos complejos debemos dejar de lado la lógica lineal y observar el contexto completo del problema. https://www.tiktok.com/@tupildoramental/video/7244885384897793307
- **El Acertijo de Edward de Bono**: El pensamiento lateral es una técnica estructurada para cambiar percepciones y encontrar nuevos caminos. https://www.tiktok.com/@edrian.exe/video/7433894810064407840
...
- **Sherlock Holmes: Ver vs Mirar**: La observación de detalles que otros ignoran es la base para encontrar soluciones ingeniosas. Pensar fuera de la caja empieza por ver. https://www.tiktok.com/@lugen.detodo/video/7074393059626061062
- **The Martian: Resolver problemas**: Cuando los recursos son limitados, la creatividad y el ingenio técnico se fusionan para crear soluciones de supervivencia. https://www.tiktok.com/@moviedailyquote/video/7349638055168429345
