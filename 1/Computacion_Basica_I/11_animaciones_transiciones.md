...
### 🔍 Caso 1 — Pasar de un tema a otro.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Transición (Desvanecer).

**Por qué importa:** Un cambio de tema suave y profesional(5).

---

### 🔍 Caso 2 — Que un dato importante resalte.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Animación de Énfasis.

**Por qué importa:** El objeto brilla o se mueve para que lo vean(4).

---

### 🔍 Caso 3 — Mostrar una imagen nueva.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Animación de Entrada.

**Por qué importa:** La foto aparece poco a poco en la pantalla(3).

---

### 🔍 Caso 4 — Ordenar tus efectos.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Panel de Animación.

**Por qué importa:** Controlas quién se mueve primero y a qué velocidad(6).

---

### 🔍 Caso 5 — Limpiar la pantalla de ideas.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Animación de Salida.

**Por qué importa:** El texto desaparece para que entre lo nuevo.

---

### 🔍 Caso 6 — Hacer que un título gire.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Animación de Énfasis.

**Por qué importa:** Una forma divertida de marcar un inicio(4).

---

### 🔍 Caso 7 — Cambio de sección rápido.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Transición (Empuje).

**Por qué importa:** Da la sensación de que las páginas se deslizan.

---

### 🔍 Caso 8 — Sincronizar con tu voz.

**Tu turno:** ¿Qué respuesta encaja mejor? Escríbela antes de abrir la clave.

**Clave:** Retraso o Duración.

**Por qué importa:** Los efectos aparecen justo cuando tú lo dices.
...
Pregúntale a un adulto: "¿Qué es lo que más te distrae cuando alguien hace una presentación con muchas animaciones?".
